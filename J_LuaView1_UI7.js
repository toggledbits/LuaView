...
var LuaView = (function(api) {
    ...
    function footer() {
        ...
        html += '<div id="tbcopyright">LuaView ver 1.0develop <a href="https://www.toggledbits.com/" target="_blank">Patrick H. Rigney (rigpapa)</a>' +
            ' Please use the ' +
            ' <a href="http://forum.micasaverde.com/index.php" target="_blank">forum thread</a> for support.</div>';
        return html;
    }
